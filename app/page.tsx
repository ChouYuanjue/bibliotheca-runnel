...
const bioContent = `
I’m **Runnel Zhang** (also Runcheng Zhang), an undergraduate at **Nanjing University’s School of Intelligent Science and Technology**. My academic path has included PKU’s summer and winter schools and, later, NJU’s CS AI communities such as **NOVA** and **AIA**. At NJU, I have shared material on full-stack development and VAEs, while also maintaining small technical projects around bots, TeX, language tools, and AI-assisted workflows. I also work as a **full-stack engineer at FluxVerse**, a startup led by Mr. Chen, where I contribute to product development. Through this collaboration, I have access to a workspace at Nanjing Alibaba Center — though I am not directly employed by the company.
