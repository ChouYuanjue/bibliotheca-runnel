...
const bioContent = `
I’m **Runnel Zhang** (also Runcheng Zhang), an undergraduate at **Nanjing University’s School of Intelligent Science and Technology**. My work sits between computer science and mathematics, with recent projects in AI4Math, low-resource NLP, TeX tooling, and bot infrastructure. I have participated in PKU summer and winter schools and in NJU technical communities including **NOVA** and **AIA**. I also work as a **full-stack engineer at FluxVerse**, contributing to product development; through this collaboration I use a workspace at Nanjing Alibaba Center, but I am not employed by Alibaba.

I am currently a Research Intern at **TsinghuaNLP**, working on **AI for Science** (AI4Sci) under Prof. Zheni Zeng, while also working on **AI for Mathematics** (AI4Math) with Ziyu Zhou at MSRA. My earlier Tangut translation project led me toward sparse and structured language problems. I am also building background in **Computer Vision**, **NLP**, and **AI interpretability**.
