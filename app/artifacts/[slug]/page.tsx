...
export default async function AchievedPage({ params }: { params: { slug: string } }) {
  ...
  return (
    <div className="max-w-3xl mx-auto py-12 px-4">
      <Link href="/artifacts" className="inline-flex items-center text-gray-500 hover:text-gray-900 mb-8 transition-colors">
      ...
      <div className="mb-8 border-b border-gray-100 pb-8">
        <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-sm text-gray-400 font-mono">
                {new Intl.DateTimeFormat("en-US", { year: "numeric", month: "short", day: "2-digit" }).format(new Date(item.date))}
            </span>
        </div>
