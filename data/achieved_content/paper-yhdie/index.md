---
title: "PAPER: The Mapping of the Main Functions and Different Variations of YH-DIE"
state: "FICTIONAL"
date: "2020-09-12"
...
> $$\int_{0}^{{x}_{i}} \frac{G\left({{x}_{i}, s}\right)}{\left({{x}_{i} - s}\right)^{\alpha}} \varphi\left(s\right) ds = f\left({{x}_{i}}\right)$$  
> $$\frac{\partial}{\partial {x}_{i}} \left( \frac{{\partial}_{{x}_{i}} G}{\sqrt{1 + \left| \nabla G \right|^2}} \right) = 0$$  
> $${i} = \sum_{{x}_{i} = 1}^{\infty} \arccos \varphi\left({{x}_{i}}\right) = f\left(\fbox{${Yuh}$}\right)$$  
...
>
> 1. The "Abstract", it should be rewritten and the following should be included.
>    (1) The purpose of the research;
>    (2) What you have done in the research;
>    (3) Research results.
...
> 3. The first section, the “Introduction”, the formula in it should be numbered.
> ... (Further detailed formatting requirements regarding numbering, figure legends, and equation editing follow.)
